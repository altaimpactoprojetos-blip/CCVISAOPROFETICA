...
export type AdminData = {stats: {submissions: number; new_submissions: number; published_events: number; photos: number}; events: EventRecord[]; galleries: GalleryRecord[]; kinds: {kind: string; total: number}[]; content: {schedule: Schedule; contact: Contact; email: EmailConfig}};
